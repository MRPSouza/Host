<?php   
    ...
    echo '<script>console.log("Incluindo visibilidade da página");</script>';
    ...
    echo '<script>console.log("Incluindo security headers");</script>';
    ...
    echo '<script>console.log("Incluindo HTML head");</script>';

    # Incluir o cabeçalho
    include_once '../private/source/pages/layouts/header.php';
    echo '<script>console.log("Incluindo cabeçalho");</script>';
