...
$csp_policy = "default-source 'self'; "
    . "script-source 'self' 'nonce-" . base64_encode(random_bytes(16)) . "' "
    . "https://www.googletagmanager.com "
    . "https://cdn.jsdelivr.net "
    . "https://code.jquery.com; "
    . "style-source 'self' 'nonce-" . base64_encode(random_bytes(16)) . "' "
    . "https://cdn.jsdelivr.net "
    . "https://cdnjs.cloudflare.com "
    . "https://fonts.googleapis.com; "
    . "font-source 'self' https://fonts.gstatic.com https://cdnjs.cloudflare.com; "
    . "img-source 'self' data:; "
    . "connect-source 'self'; "
    . "form-action 'self'; "
